...
| `healthcare#_msft_clinical_data_foundation_ingestion` | Pipeline | Clinical data ingestion (also included in imaging pipeline) |\n| `healthcare#_msft_imaging_with_clinical_foundation_ingestion` | Pipeline | DICOM imaging + clinical data ingestion (use this one) |\n| `healthcare#_msft_omop_analytics` | Pipeline | Silver \u2192 Gold OMOP CDM v5.4 transformation |
