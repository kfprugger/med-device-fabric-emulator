...
const MOCK_PHASES: MockPhase[] = [
  ...
  // ── Phase 5 ──
  {
    phase: "6. Population Health & Quality: Full analytics pipeline",
    durationMs: 18000,
    logs: [
      { delayPct: 0, level: "info", message: "Discovering Gold Reporting Lakehouse…" },
      { delayPct: 3, level: "success", message: "Gold Lakehouse: healthcare1_reporting_gold" },
      { delayPct: 5, level: "info", message: "Step 1-4: Materializing claims star schema…" },
      { delayPct: 12, level: "success", message: "dim_payer (8), dim_diagnosis (1,250), fact_claim (48K), fact_diagnosis (125K)" },
      { delayPct: 15, level: "info", message: "Step 5-6: Computing CMS quality measures (7 eCQMs)…" },
      { delayPct: 25, level: "success", message: "agg_quality_measures: 35,000 rows across 7 measures" },
      { delayPct: 28, level: "info", message: "Step 6: Computing medication adherence PDC scores…" },
      { delayPct: 32, level: "success", message: "agg_medication_adherence: 6,200 rows (PDC-DR, PDC-RASA, PDC-STA)" },
      { delayPct: 34, level: "info", message: "Step 7: Identifying care gaps…" },
      { delayPct: 38, level: "success", message: "care_gaps: 12,400 open gaps" },
      { delayPct: 40, level: "info", message: "Step 8: Computing Star Ratings (2025 CMS cut points)…" },
      { delayPct: 48, level: "success", message: "star_rating_detail: 10 measures, overall weighted star: 3.2" },
      { delayPct: 50, level: "success", message: "star_rating_simulation: 50 what-if scenarios" },
      { delayPct: 52, level: "info", message: "Step 9: HCC Risk Adjustment (CMS-HCC V28)…" },
      { delayPct: 58, level: "success", message: "dim_hcc: 22 HCC categories" },
      { delayPct: 60, level: "success", message: "agg_risk_scores: 1,460 patients, avg RAF: 0.847" },
      { delayPct: 62, level: "success", message: "revenue_opportunity: 340 patients with coding gaps" },
      { delayPct: 64, level: "info", message: "Step 10: Training readmission risk model (LogisticRegression)…" },
      { delayPct: 72, level: "success", message: "readmission_risk_scores: 8,200 encounters scored (AUC: 0.714)" },
      { delayPct: 74, level: "info", message: "Step 11: Computing cost & utilization analytics…" },
      { delayPct: 80, level: "success", message: "PMPM: $1,247 | IP/1K: 285 | ED/1K: 442 | ALOS: 4.8" },
      { delayPct: 82, level: "success", message: "agg_high_cost_claimants: 73 patients (≥95th percentile)" },
      { delayPct: 85, level: "info", message: "Publishing Population Health & Quality Dashboard (Direct Lake, 10 pages)…" },
      { delayPct: 90, level: "success", message: "Population Health & Quality Dashboard deployed (58 DAX measures)" },
      { delayPct: 93, level: "info", message: "Configuring ReadmissionRiskAlert (Data Activator)…" },
      { delayPct: 96, level: "success", message: "ReadmissionRiskAlert: daily email at 8:00 AM ET" },
